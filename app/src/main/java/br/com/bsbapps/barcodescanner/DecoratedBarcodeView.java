    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (barcodeView == null) {
            throw new IllegalArgumentException(
                "There is no a br.com.bsbapps.barcodescanner.BarcodeView on provided layout " +
        ...
        if (viewFinder == null) {
            throw new IllegalArgumentException(
                "There is no a br.com.bsbapps.barcodescanner.ViewfinderView on provided layout " +
