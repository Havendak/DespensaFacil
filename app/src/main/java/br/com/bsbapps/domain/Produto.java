...
public class Produto {
    ...
    public Produto(String barcode, String nomeProduto, int idMedida, int quantidade, String descricao, int idTipo, int idSubtipo, int favorito, int status) {
